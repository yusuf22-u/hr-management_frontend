            ...
            <div className="bg-white p-4 rounded-lg shadow-lg max-w-lg w-full">
                ...
                <div className="flex justify-center mb-4">
                    {employee.profile_pic ? (
                        <img src={`${employee.profile_pic}`} alt={employee.full_name} className="w-24 h-24 object-cover rounded-full" />
                    ) : (
                    ...
                    <>
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg mb-3 flex justify-between space-x-2">
                            <div className="mb-1">
                                ...
                                <span className="capitalize text-gray-700 ml-2">{employee.full_name}</span>
                            </div>
                            <div className="mb-1">
                                <span className="font-semibold text-gray-600">D.O.B:</span>
                                <span className="capitalize text-gray-700 ml-2">{formatDate(employee.date_of_birth)}</span>
                            </div>
                            <div className="mb-1">
                                <span className="font-semibold text-gray-600">Department:</span>
                                <span className="capitalize text-gray-700 ml-2">{employee.department}</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg flex justify-between mb-3 space-y-1">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="capitalize text-gray-700 text-sm">{employee.address}</span>
                            </div>
                            <div className="flex items-center">
                                <AiOutlinePhone className="text-red-500 w-5 h-5 mr-2" />
                                <span className="text-gray-700 text-sm">{employee.phone_number}</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg">
                            <div className="flex justify-between">
                                ...
                                <span className="text-gray-700 text-sm">{formatDate(employee.date_of_admission)}</span>
                            </div>
                        </div>
                    </>
                ) : (
